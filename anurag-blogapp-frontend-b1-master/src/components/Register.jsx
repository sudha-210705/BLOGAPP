  ...
  const onUserRegister = async (newUser) => {
    ...
    try {
      if (role === "user") {
        ...
        let resObj = await axios.post("https://blogapp-ps2r.onrender.com/user-api/users", formData);
      ...
      if (role === "author") {
        ...
        //make API req to user-api
        let resObj = await axios.post("https://blogapp-ps2r.onrender.com/author-api/users", formData);
